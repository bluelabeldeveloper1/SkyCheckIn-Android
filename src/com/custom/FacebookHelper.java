...
public class FacebookHelper
{
	...
	public static String LOGOUT_SUCESS = "logout_sucess";
	public static String FRIENDLIST_SUCESS = "friendlist_sucess";
		...
		public void call(Session session, SessionState state, Exception exception)
		{
			...
			if (state == SessionState.OPENED)
			{
				...
				else
				{
					...
					{
						facebookHelperListerner.onComplete(LOGIN_SUCESS, 0);
					}
			...
			{
				facebookHelperListerner.onComplete(LOGOUT_SUCESS, 0);
			}
